...
<head>
  ...
  <link   href="{{asset('vendor/datatables/dataTables.bootstrap4.css')}}">
    ...
    <link href="{{ asset('css/sb-admin-2.min.css') }}" rel="stylesheet">
     <link rel="stylesheet" href="{{url('https://cdn.bootcss.com/toastr.js/latest/css/toastr.min.css')}}">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
          ...
          <div class="sidebar-brand-text mx-3">FireStore</div>
        </a>
        <!-- Divider -->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
               <span>Copyright &copy;  firestore.com <?php  echo date("Y"); ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
